...
//  }
  ...
  static final String gfzReportFormData ='''
  {
    "result": [
        ...
        {
            "title": "原材料入库",
            "functionName": "goMaterialStorage",
            "id": 2
        },
         {
            "title": "成品入库列表",
  ...
  //特缆工业4.0模块
  static final String tlIndustryData ='''
  {
    "result": [
        {
            "title": "芯线生产量列表",
            "functionName": "goTLList",
            "id": 1
        },
        {
            "title": "芯线月产量查询",
            "functionName": "goTLMonthQuery",
            "id": 2
        },
         {
            "title": "芯线异常查询",
            "functionName": "goTLExceptionQuery",
            "id": 3
        },
         {
            "title": "半成品盘点",
            "functionName": "goTLInventory",
            "id": 4
        }
    ],
    "msg": "成功",
